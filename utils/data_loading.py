...
def full_dataset(dataset_name):
    train_tools, test_tools = datasets_definiton(dataset_name)
    train_datasets = [ToolDataset(dir_train_img, dir_train_mask, tool_name) for tool_name in train_tools]
    val_datasets = [ToolDataset(dir_val_img, dir_val_mask, tool_name) for tool_name in train_tools]
    test_datasets = [ToolDataset(dir_test_img, dir_test_mask, tool_name) for tool_name in train_tools]
    test_unseen_datasets = [ToolDataset(dir_test_img, dir_test_mask, tool_name) for tool_name in test_tools]
    ...
    print('------------------------------------------------------')
    return train_dataset, val_dataset, test_dataset, test_unseen_dataset
...
class ToolDataset(BasicDataset):
    def __init__(self, images_dir, mask_dir, tool_name, scale=1, mask_suffix: str = ''):
